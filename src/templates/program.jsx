  ...
  return (
    <React.Fragment>
      <Layout>
          ...
          <div class="container mx-auto">
            <div className="flex flex-col lg:flex-row justify-center items-center">
              <div className="w-full lg:w-1/2">
                <h1 className="uppercase rustico text-white text-6xl leading-none">{prismicProgram.data.title.text}</h1>
                <p className="text-white text-2xl" style={{ maxWidth: "500" + "px"}}>{prismicProgram.data.lead.text}</p>
                <div className="mt-10">
                    ...
                    <div className="px-6 py-4">
                      ...
                      <ul class="flex my-5">
                        <li class="flex-1 mr-2">
                          <a class="text-center block border rounded py-2 px-4 bg-red-500 hover:bg-red-700 text-white" href="#">4 days</a>
                        </li>
                        <li class="flex-1 mr-2">
                          <a class="text-center block border border-white rounded hover:border-gray-200 text-red-500 hover:bg-gray-200 py-2 px-4" href="#">5 days</a>
                        </li>
                        <li class="text-center flex-1">
                          <a class="text-center block border border-white rounded hover:border-gray-200 text-red-500 hover:bg-gray-200 py-2 px-4" href="#">6 days</a>
                        </li>
                      </ul>
                      ...
                      <p className="text-gray-700 text-base">Fitness level: Intermediate</p>
        ...
        <div className="py-20 block lg:hidden" style={{ backgroundImage: 'linear-gradient(to right, ' + prismicProgram.data.bg_col_gradient_1 + ',' + prismicProgram.data.bg_col_gradient_2 + ')'}}>
          <div className="w-full lg:w-1/2">
            <div className="flex justify-center">
              <div className="max-w-sm rounded overflow-hidden bg-white shadow-lg z-50 md:mt-auto">
                <div className="px-6 py-4">
                  ...
                  <ul class="flex my-5">
                    <li class="flex-1 mr-2">
                      <a class="text-center block border border-blue-500 rounded py-2 px-4 bg-red-500 hover:bg-red-700 text-white" href="#">4 days</a>
                    </li>
                    <li class="flex-1 mr-2">
                      <a class="text-center block border border-white rounded hover:border-gray-200 text-red-500 hover:bg-gray-200 py-2 px-4" href="#">5 days</a>
                    </li>
          ...
          <div className="container mx-auto py-20 h-full">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center z-50 h-full">
              <div class="flex flex-col justify-center w-full lg:w-1/3 h-full text-center py-5">
                <img src={"../1circle.png"} alt="checked-icon" width={"75px"} className="mx-auto" />
                <h3 className="text-2xl">Pick Your <span className="rustico">Program</span></h3>
                <p className="mx-auto mt-5" style={{ maxWidth: '300' + 'px'}}>This is a paragraph about joining a program and hitting your goals</p>
              </div>
              <div className="flex flex-col justify-center w-full lg:w-1/3 h-full text-center py-5">
                <img src={"../1circle.png"} alt="checked-icon" width={"75px"} className="mx-auto" />
                <h3 className="text-2xl">Start <span className="rustico">Training</span></h3>
                <p className="mx-auto mt-5" style={{ maxWidth: '300' + 'px'}}>This is a paragraph about joining a program and hitting your goals</p>
              </div>
              <div class="flex flex-col justify-center w-full lg:w-1/3 h-full text-center py-5">
                <img src={"../1circle.png"} alt="checked-icon" width={"75px"} className="mx-auto" />
                <h3 className="text-2xl">Join the <span className="rustico">#FitCult</span></h3>
                <p className="mx-auto mt-5" style={{ maxWidth: '300' + 'px'}}>This is a paragraph about joining a program and hitting your goals</p>
              </div>
            </div>
          </div>
        ...
        <div className="py-20">
          <div className="container mx-auto">
            <div className="flex flex-col lg:flex-row justify-center items-center">
              <div className="w-full lg:w-1/2">
                <img src={ prismicProgram.data.phone_img.url } alt="checked-icon" width={"100%"} className="mx-auto" />
              </div>
              <div className="w-full lg:w-1/2 p-10">
                ...
                <div className="max-w-sm w-full lg:max-w-1/2 flex flex-col lg:flex-row mt-20">
                  <div className="hidden lg:block h-48 md:h-auto lg:h-auto w-full lg:w-32 flex-none bg-cover bg-center rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style={{ backgroundImage: 'url(' + prismicProgram.data.card_testimonial_image.url + ')'}}>
                  </div>
            ...
            <div className="flex justify-center mt-10">
              <div className="w-full lg:w-1/2">       
                <Slider arrows={ true } dots={ true } infinite={ true } speed={ 500 } slidesToShow={ 1 } slidesToScroll = { 1 }>
                  <div>
                    <img src={ prismicProgram.data.testimonial_image_1.url } width="100%" />
                  </div>
                  <div>
                    <img src={ prismicProgram.data.testimonial_image_1.url } width="100%" />
                  </div>
        ...
        <div className="py-20">
          <div className="container mx-auto p-10">
            <h3 className="text-center uppercase text-3xl mb-10">Questions and <span className="rustico">Answers</span></h3>
                <div className="flex flex-col lg:flex-row justify-center">
                  <div className="w-full lg:w-3/4 border-b border-gray-400  bg-white p-4 flex flex-col justify-between leading-normal">
                    <div className="py-6">
                      <div className="text-gray-900 font-bold text-xl mb-2">Question 1</div>
                      <p className="text-gray-700 text-base">I've lost 32 pounds since I downloaded tha app. The shear presence of it in my pocket has yielded serious results! I highly recommend it.</p>
                    </div>
                  </div>
                </div>
                <div className="flex flex-col lg:flex-row justify-center">
        ...
        <div className="pt-20 pb-32" style={{ backgroundColor: "#F9F9F9" }}>
          <div className="container mx-auto p-10">
            <h3 className="text-center mb-6 uppercase text-3xl">Join the <span className="rustico">#FitCult</span></h3>
            <div className="flex flex-col lg:flex-row justify-center items-center">
              <div className="w-full lg:w-1/2">
                <div class="flex flex-col lg:flex-row justify-between items-center border rounded py-6 px-3 shadow bg-white">
                  <input className="appearance-none border-none rounded w-auto py-1 px-2 text-gray-700 leading-tight text-xl focus:outline-none"  type="email" placeholder="youremail@email.com"></input>
                  <Link to="/" className="btn-lg btn-red shadow-md w-auto mt-10 lg:mt-auto">Join the Cult</Link>
                </div>
              </div>
            </div>
          </div>
