  ...
  return (
        ...
        <div className="container mx-auto px-5 pb-5 pt-3">
          <div className="flex flex-col lg:flex-row justify-center items-center">
            ...
            <div className="w-full lg:w-1/2 relative mt-10">
              <video muted playsInline autoPlay loop controls className="mx-auto">
    ...
    <div className="py-20 bg-gray-900">
      <div className="container lg:mx-auto px-5">
        <h3 className="statement text-white text-center text-3xl pb-5 lg:pb-10">
          Join the <span className="px-2" style={{backgroundImage: 'linear-gradient(to right, ' + node.colorOne.hex + ',' + node.colorTwo.hex + ')'}}>#FitCult</span> Family
        </h3>
      </div>
        ...
        <div ref={programRow} className="flex flex-row flex-nowrap items-stretch h-full overflow-x-scroll lg:overflow-x-hidden scroll-x-mandatory smooth">

          {
            node.testimonials.map((program,i) => {
              return (
                <div ref={programDiv} key={i} className="w-full md:w-1/2 lg:w-1/5 mx-3 rounded-sm bg-gray-600 mt-10 flex flex-col items-stretch snap-align-center" style={{minWidth: "300px"}}>
                  <Img
                  ...
                  />
                  <div className="flex flex-col justify-between items-stretch flex-grow p-5">
                    <p className="text-white text-xs italic">"{program.quote}"</p>
                    <div>
                      <h6 className="uppercase">{program.member}</h6>
                      <span className="text-black text-xs">{program.location}</span>
                    </div>
                  </div>
                </div>
              )
