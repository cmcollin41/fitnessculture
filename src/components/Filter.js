		...
		return (
			<React.Fragment>
				<div className="flex flex-row justify-center">
					<button className={"rounded-sm border border-black px-4 py-1 mx-3 " + (this.state.visible === "all" ? "filter-active" : "")} onClick={this.filter} value="all">All</button>
					<button className={"rounded-sm border border-black px-4 py-1 mx-3 " + (this.state.visible === "women" ? "filter-active" : "")} onClick={this.filter} value="women">Women</button>
					<button className={"rounded-sm border border-black px-4 py-1 mx-3 " + (this.state.visible === "men" ? "filter-active" : "")} onClick={this.filter} value="men">Men</button>
				</div>
