      ...
      <footer className="w-full footer mt-auto bg-gray-900">
        <div className="container mx-auto px-10 lg:px-auto py-20">
          <div className="flex flex-col lg:flex-row">
            <div className="w-full lg:w-1/4 pr-10">
            ...
            <div className="w-full lg:w-1/4 mt-10 lg:mt-0">
                ...
                <div className="flex flex-col pb-2 left-0 right-0">
                  {data.allSanityProgram.nodes.map((i, count) => (
                    <Link to={"/programs/" + i.slug.current} key={count} className="uppercase block mt-5 lg:inline-block text-gray-300 hover:text-blue-500 mr-4 text-xs">{i.title}</Link>
                  ))}
              </div>
            </div>
