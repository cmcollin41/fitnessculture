        ...
        <div className="flex flex-row flex-wrap -mx-5">
          ...
          <div className="w-full lg:w-1/3 order-0 lg:order-1 px-5">
            <div className="bg-white shadow p-5">
              ...
              <div className="flex justify-between items-center">
                <p className="uppercase text-xs font-bold flex flex-row">Estimated Taxes <span data-tip data-for="estimated taxes"><img alt="estimaed taxes explanation" width="16px" className="ml-2" src={"data:image/png;base64,"}/></span></p>
              ...
              <button onClick={handleCheckout} className="mb-4 px-2 py-4 bg-black text-white uppercase w-full rounded-sm">Check out</button>  
              ...
              <div className="flex flex-row items-center">
                ...
                <img alt="paypal" src={paypal} width="35px" />
