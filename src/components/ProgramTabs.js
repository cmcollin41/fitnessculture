    ...
    return (
      ...
      <Tabs selectedTabClassName="active-tab">
        <TabList className="arrow-steps lg:flex lg:flex-row lg:justify-center lg:mx-auto sticky top-59 lg:relative lg:top-auto z-40">
          <Tab className="step uppercase font-light w-full lg:w-1/3 text-left lg:text-center text-white no-style-ul">1. Who is it for?</Tab>
          <Tab className="step uppercase font-light w-full lg:w-1/3 text-left lg:text-center text-white no-style-ul">2. How does it work?</Tab>
          <Tab className="step uppercase font-light w-full lg:w-1/3 text-left lg:text-center text-white no-style-ul">3. What should I expect?</Tab>
        </TabList>
        <TabPanel>
